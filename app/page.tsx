      ...
      <footer className="py-16 px-6 bg-[#0f172a] border-t border-[#334155] text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex justify-center gap-6 mb-10">
            ...
            <a href="https://wa.me/1172145711" target="_blank" rel="noopener noreferrer" className="text-[#9ca3af] hover:text-[#22c55e] transition-all flex flex-col items-center gap-1">
