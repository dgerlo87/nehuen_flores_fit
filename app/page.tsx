...
<footer className="relative py-16 px-6 bg-[#0f172a] border-t border-[#334155] text-center overflow-hidden">
  ...
  <div className="relative z-10 max-w-2xl mx-auto">
    ...
    <a href="#formulario" className="bg-[#16a34a] px-10 py-4 rounded-xl font-bold text-sm hover:bg-[#22c55e] transition-all uppercase inline-block mb-12 text-white shadow-lg">
      QUIERO MI RUTINA
    </a>
    ...
    <div className="mb-8">
      <img src="/IMG-20251216-WA0001.jpg" alt="Logo" className="h-12 mx-auto mb-4 opacity-90 rounded-full border border-[#22c55e]" />
